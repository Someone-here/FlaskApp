...
inputs.forEach((e) => {
  e.addEventListener("input", () => {
    var selected = document.getElementsByClassName(
      e.getAttribute("placeholder").replace(":", "").replace(/\s+/g, "").trim()
    );
...
submit.addEventListener("click", () => {
  ...
  if (allFilled) {
    ...
    var stripe = Stripe(
      "pk_test_51IdTodSIXcXkEUKCUcQmjxWfgpVJKrlVy1TqH1vOjhELy3g2dHDxhtkjo1NrLtqeBdnGlrrpVrQbTxMZk9u8EySd00JG3tKeiR"
    );
